...
public class Dino {
	...
	//private static final int[] HITBOX_RUN = {24, 52, -64, -84};
//	private static final int[] HITBOX_DOWN_RUN = {24, 8, -60, -24};
	...
	public Dino(Controls controls) {
		...
		dinoRun.addSprite(getImage("resources/kanan 0.png"));
		dinoRun.addSprite(getImage("resources/kanan 1.png"));
		dinoRun.addSprite(getImage("resources/kanan 2.png"));
		dinoRun.addSprite(getImage("resources/kanan 3.png"));
		dinoRun.addSprite(getImage("resources/kanan 4.png"));
		dinoRun.addSprite(getImage("resources/kiri 0.png"));
		dinoRun.addSprite(getImage("resources/kiri 0.png"));
		dinoRun.addSprite(getImage("resources/kiri 1.png"));
		dinoRun.addSprite(getImage("resources/kiri 2.png"));
		dinoRun.addSprite(getImage("resources/kiri 3.png"));
		dinoRun.addSprite(getImage("resources/kiri 4.png"));
		dinoDownRun = new Animation(150);
		dinoDownRun.addSprite(getImage("resources/kanan 0.png"));
		dinoDownRun.addSprite(getImage("resources/kiri 0.png"));
		dinoJump = getImage("resources/kanan 2.png");
		dinoDead = getImage("resources/kiri 2.png");
